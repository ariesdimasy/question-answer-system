...
type CategoryUseCaseDomain interface {
	...
	GetCategoryById(ctx context.Context, id uint) (CategoryDomain, error)
	...
	DeleteCategory(ctx context.Context, id uint) (CategoryDomain, error)
}

type CategoryRepository interface {
	GetAllCategories(ctx context.Context) (
		res []CategoryDomain, err error)
	GetCategoryById(ctx context.Context, id uint) (res CategoryDomain, err error)
	...
	DeleteCategory(ctx context.Context, id uint) (res CategoryDomain, err error)
}
